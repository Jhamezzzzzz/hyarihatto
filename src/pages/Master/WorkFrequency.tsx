...
const AccidentLevel = () => {
  ...
  return (
    <div>
      <PageMeta title="Master Frekuensi Kerja | Online Hyarihatto & Voice Member" description="Online sistem sebagai digitalisasi buku catatan Hyarihatto" />
