...
export default function QuestUser() {
  ...
  const inputCameraFrontRef = useRef<HTMLInputElement | null>(null);
  const inputCameraBackRef = useRef<HTMLInputElement | null>(null);
  ...
  const [formCheckBox, setFormCheckBox] = useState<FormCheckBoxType>({
    jenis: [],
    sumber: [],
    terluka: [],
    sebab: [],
...
const handleChange = (
  ...
  const handleCheckboxChange = (e: React.ChangeEvent<HTMLInputElement>, field: keyof FormCheckBoxType) => {
